function visualization(tmp) {
    ...
    d3.json("data/Kandidaten.json", function (error, data) {
        ...
        if (budgetfrage) {
            ...
            var colors = d3.scale.ordinal()
                .range(["#f44f4f", "#e29988", "#cbc8bf", "#a9d654", "#26ac3b"]);
            ...
            var colors = d3.scale.ordinal()
                .range(["#f44f4f", "#e29988", "#a9d654", "#26ac3b"]);
        }
        ...
        /*parsedata.sort(function(a, b) {
           return b.responses[0].yp1 - a.responses[0].yp1;
        });*/
